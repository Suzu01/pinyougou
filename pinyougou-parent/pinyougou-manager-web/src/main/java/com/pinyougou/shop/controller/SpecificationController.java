...
public class SpecificationController {
	...
	/**
	 * 增加
	 * @param specificationOptionGroup
	 * @return
	 */
	@RequestMapping("/add")
	public Result add(@RequestBody SpecificationOptionGroup specificationOptionGroup){
		...
		try {
			...
			List<TbSpecificationOption> specificationOptionList = specificationOptionGroup.getSpecificationOptionList();
	...
	public Result update(@RequestBody SpecificationOptionGroup specification){
		try {
